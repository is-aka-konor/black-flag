...
export const ammunition = {
	arrow: {
		...
		link: "Compendium.black-flag-ru.items.Item.pLXuZs8PTiEt5PmK"
	},
	blowgunNeedle: {
		localization: "BF.AMMUNITION.Type.BlowgunNeedle",
		link: "Compendium.black-flag-ru.items.Item.2m22nW2ojmJJm0xW"
	},
	crossbowBolt: {
		localization: "BF.AMMUNITION.Type.CrossbowBolt",
		link: "Compendium.black-flag-ru.items.Item.cUcIM6yesvDT51kY"
	},
	paperCartridge: {
	...
	slingBullet: {
		...
		link: "Compendium.black-flag-ru.items.Item.gJkNOy9ZuXqxuFYN"
	}
};
