	...
	simple: {
		...
		children: {
			...
			club: {
				...
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.WhFDR7nOBaBhhwmp"
			},
			dagger: {
				label: "BF.WEAPON.Base.Dagger",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.3bEIZYDB4eMayC6k"
			},
			greatclub: {
				label: "BF.WEAPON.Base.Greatclub",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.QAPscsGRbv5l778n"
			},
			handaxe: {
				label: "BF.WEAPON.Base.Handaxe",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.y6xWtgpXkPkn8cqO"
			},
			javelin: {
				label: "BF.WEAPON.Base.Javelin",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.8wAd9MmtaW1tizSN"
			},
			lightHammer: {
				label: "BF.WEAPON.Base.LightHammer",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.JBfKqjO5hbNcX6zN"
			},
			mace: {
				label: "BF.WEAPON.Base.Mace",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.XOrCLbriQXUoLCTL"
			},
			quarterstaff: {
				label: "BF.WEAPON.Base.Quarterstaff",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.B5J4heAlwqhvzXKW"
			},
			sickle: {
				label: "BF.WEAPON.Base.Sickle",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.MLfeXpp9ZSPKrB7w"
			},
			spear: {
				label: "BF.WEAPON.Base.Spear",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.eG0Vk1Kr8peAAYhW"
			},
			// Simple Ranged
			lightCrossbow: {
				label: "BF.WEAPON.Base.CrossbowLight",
				type: "ranged",
				link: "Compendium.black-flag-ru.items.Item.Zu15sMMg2KvxhA3e"
			},
			dart: {
				label: "BF.WEAPON.Base.Dart",
				type: "ranged",
				link: "Compendium.black-flag-ru.items.Item.14pCY7bJYfjnSZqB"
			},
			pistol: {
			...
			sling: {
				...
				type: "ranged",
				link: "Compendium.black-flag-ru.items.Item.QoMwONkjb7knNonO"
			}
		}
	},
	martial: {
		...
		children: {
			...
			battleaxe: {
				...
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.bDVnEZSy0tcZg0js"
			},
			flail: {
				label: "BF.WEAPON.Base.Flail",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.eEVYQ21cIi97CRl1"
			},
			glaive: {
				label: "BF.WEAPON.Base.Glaive",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.caf9G1uCz7agcoym"
			},
			greataxe: {
				label: "BF.WEAPON.Base.Greataxe",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.9EAkaGqWPK0qFoDq"
			},
			greatsword: {
				label: "BF.WEAPON.Base.Greatsword",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.LG9czlXCwzBSmWR4"
			},
			halberd: {
				label: "BF.WEAPON.Base.Halberd",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.PV6JskvwVJ9BVvQb"
			},
			lance: {
				label: "BF.WEAPON.Base.Lance",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.vDPNvqRkuKnzAbvR"
			},
			longsword: {
				label: "BF.WEAPON.Base.Longsword",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.ym1owWiMSNOcZNdO"
			},
			maul: {
				label: "BF.WEAPON.Base.Maul",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.WWJHSzi0T466vB3o"
			},
			morningstar: {
				label: "BF.WEAPON.Base.Morningstar",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.zWBmus194O0RLxeU"
			},
			pike: {
				label: "BF.WEAPON.Base.Pike",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.ib6aTaDTjlnG3m54"
			},
			rapier: {
				label: "BF.WEAPON.Base.Rapier",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.pcyyBxMi5naeXbSt"
			},
			scimitar: {
				label: "BF.WEAPON.Base.Scimitar",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.MwYjehTr9oJlHb1Z"
			},
			scythe: {
				label: "BF.WEAPON.Base.Scythe",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.4diYN02TlcURqvK3"
			},
			shortsword: {
				label: "BF.WEAPON.Base.Shortsword",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.C9nwbmL7uTX8t8nr"
			},
			trident: {
				label: "BF.WEAPON.Base.Trident",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.KOE2ZOUMtbY0OkS9"
			},
			warPick: {
				label: "BF.WEAPON.Base.WarPick",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.EcuWrcnF6FY79arQ"
			},
			warhammer: {
				label: "BF.WEAPON.Base.Warhammer",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.E7IJC52xWk7Utk4p"
			},
			whip: {
				label: "BF.WEAPON.Base.Whip",
				type: "melee",
				link: "Compendium.black-flag-ru.items.Item.teX6pEUhupO8LBTu"
			},
			// Martial Ranged
			arquebus: {
			...
			blowgun: {
				...
				type: "ranged",
				link: "Compendium.black-flag-ru.items.Item.5jfXHBmPqbspahJk"
			},
			blunderbuss: {
			...
			handCrossbow: {
				...
				type: "ranged",
				link: "Compendium.black-flag-ru.items.Item.b126bs62p8TQIYZ8"
			},
			heavyCrossbow: {
				label: "BF.WEAPON.Base.CrossbowHeavy",
				type: "ranged",
				link: "Compendium.black-flag-ru.items.Item.Z8Wz5qUi16C36QQd"
			},
			longbow: {
				label: "BF.WEAPON.Base.Longbow",
				type: "ranged",
				link: "Compendium.black-flag-ru.items.Item.IpWwpPrnKuwHQpVw"
			},
			musket: {
